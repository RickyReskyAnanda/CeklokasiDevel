...
<head>
        ...
        <!-- MULTI PLUGINS -->
        <link href="<?=asset('2b212/global/plugins/bootstrap-select/css/bootstrap-select.css')?>" rel="stylesheet" type="text/css" />
        <link href="<?=asset('2b212/global/plugins/jquery-multi-select/css/multi-select.css')?>" rel="stylesheet" type="text/css" />
        <link href="<?=asset('2b212/global/plugins/select2/css/select2.min.css')?>" rel="stylesheet" type="text/css" />
        <link href="<?=asset('2b212/global/plugins/select2/css/select2-bootstrap.min.css')?>" rel="stylesheet" type="text/css" />
        <!-- END MULTI PLUGINS -->
...
<![endif]-->
            ...
            <script src="<?=asset('2b212/global/plugins/jquery-easypiechart/jquery.easypiechart.min.js')?>" type="text/javascript"></script>
            <!-- END PAGE LEVEL PLUGINS -->
            <!-- BEGIN PAGE LEVEL PLUGINS -->
            ...
            <!-- END PAGE LEVEL PLUGINS -->
            <!-- MULTI PLUGINS -->
            <script src="<?=asset('2b212/global/plugins/bootstrap-select/js/bootstrap-select.min.js')?>" type="text/javascript"></script>
            <script src="<?=asset('2b212/global/plugins/jquery-multi-select/js/jquery.multi-select.js')?>" type="text/javascript"></script>
            <script src="<?=asset('2b212/global/plugins/select2/js/select2.full.min.js')?>" type="text/javascript"></script>
            <!-- MULTI PLUGINS -->
            <!-- END PAGE Detail Venue SCRIPTS -->
            ...
            <!-- MULTI SCRIPTS -->
            <script src="<?=asset('2b212/pages/scripts/components-multi-select.min.js')?>" type="text/javascript"></script>
            <!-- END MULTI SCRIPTS -->
            <!-- BEGIN PAGE LEVEL SCRIPTS -->
